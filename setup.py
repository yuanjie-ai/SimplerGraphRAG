...
setup(
    ...
    entry_points={
        'console_scripts': [
            'simpler_graphrag-run=simpler_graphrag.clis.cli:cli'
        ],
    },
    ...
    packages=find_packages(include=['simpler_graphrag', 'simpler_graphrag.*']),

    test_suite='tests',
    url='https://github.com/yuanjie-ai/simpler_graphrag',
